...
module "virtualmachine" {
  ...
  vm_rg_location = module.virtual_network.vnet_rg_location_output
...
module "storage_account" {
  ...
  sa_rg_location = module.virtual_network.vnet_rg_location_output
...
module "key_vault" {
  ...
  kv_rg_location     = module.virtual_network.vnet_rg_location_output
